<div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md dark:bg-gray-800">
    ...
    <form method="POST" action="{{ route('contact.submit') }}" class="space-y-4">
        ...
        <div>
            <button type="submit"
                class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 dark:bg-yellow-500 dark:hover:bg-yellow-600">
                Submit
            </button>
        </div>
    </form>
