<div data-aos="fade-up" class="flex flex-col gap-y-10 p-5 mt-20">
            ...
            <div>
                <div class="hidden max-w-screen-2xl lg:flex mx-auto justify-around items-center py-14 gap-x-5">
                    <x-button>Community Development</x-button>
                ...
                <div class="flex flex-col max-w-7xl lg:flex-row gap-x-20 mx-auto">
                    <div class=" h-full w-full">
                        <img  class="w-full h-full " src="{{ asset('images/home/social.svg') }}" alt="">
                    </div>
                    <div class="flex flex-col   w-full justify-center ">
                        <x-p class="text-start font-bold px-2 py-3">Key Focus Areas</x-p>
                        <ul class="py-6 px-2">
