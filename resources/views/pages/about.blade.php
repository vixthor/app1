<x-app-layout>
        <div data-aos="fade-up" class="flex flex-col  md:flex-row container mx-auto py-20 px-5">
            <div class="w-full md:w-1/2 space-y-3 pb-3">
             ...
             <div class="w-full md:w-1/2">
                ...
                <div class=" justify-center w-full items-center  gap-y-3 grid grid-cols-2">
                    <div class=" font-semibold text-5xl flex  flex-col  p-10 ">
