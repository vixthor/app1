...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css" />
    ...
    <body class="font-montserrat antialiased ">
        ...
        <div class="">
                <div class="mx-auto  ">
                    <header class="flex flex-col   mx-auto text-black p-6">
                        <nav class="h-28">
                            <div class="flex mx-auto max-w-7xl items-center justify-between">
                                <div class="">
                                    <x-application-logo class="w-3 h-3 fill-current text-gray-500" />
                                </div>
                                <div>
                                    <ul class="flex gap-4">
                                        <li>
                                        ...
                                        <li >
                                            <a class="bg-button-blue px-4 py-2 text-white rounded-lg" href="">Financial Reviews</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>   
